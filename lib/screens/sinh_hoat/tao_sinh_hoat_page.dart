...
class TaoSinhHoatPage extends StatefulWidget {
  const TaoSinhHoatPage({Key? key}) : super(key: key);

  @override
  State<TaoSinhHoatPage> createState() => _TaoSinhHoatPageState();
}

class _TaoSinhHoatPageState extends State<TaoSinhHoatPage> {
  ...
  void initState() {
    ...
    super.initState();
    _ngayController = DateTime(2023, 1, 1);
  }
                ...
                child: TextButton(
                    style: ButtonStyle(
                        padding: MaterialStateProperty.all<EdgeInsets>(
                            EdgeInsets.zero)),
                    onPressed: () async {
                      await SinhHoat.create(SinhHoat(chude: _chudeController.text,batdau: concatwithDatetime(_batdau, _ngayController),ketthuc: concatwithDatetime(_ketthuc, _ngayController),diadiem: _diadiemController.text));
